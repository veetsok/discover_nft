...
import BestSellItems from "../../UI_KIT/Cells/BestSellItems.cell";
import { collectionData } from "./const";

interface BestSallerProps {}

const BestSaller: React.FC<BestSallerProps> = () => {
  return (
    <ST.Container>
      <ST.Navbar>
        <Text type={TextEnum.enum_H4Text} children="Best Sellers" />
        <Button
